...
//	@Scheduled(cron = "0 0 7 * * *")
	...
	public void KRAReminderMailToEMp() {
		 ...
		 */
			 ...
			 */
			/*
			 * @Scheduled(cron = "0 0 0/3 * * ?") public void updateKpiCycle() { if
			 * (kpiCycleScheduler.equalsIgnoreCase(IHRMSConstants.IS_SCHEDULER_ENABLED)) {
			 * logger.info("Update KPI Cycle Scheduler triggered"); try {
			 * kraServiceImpl.updateKpiCycleStatus(); } catch (Exception e) {
