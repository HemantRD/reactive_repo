...
public class MarathiHelper {
	...
	public String devanagariToLatin(String marathiString) {
		...
		// final String DEV_TO_LATIN_NO_ACCENTS = "Devanagari-Latin; nfd; [:nonspacing
		// mark:] remove; nfc";
