...
public class OrganazationController {
	...
	@Operation(
		    summary = "API to fetch list of active HR employees",
		    description = "This API returns a list of all active employees having the HR role along with their name, department, grade, and email details."
		)
