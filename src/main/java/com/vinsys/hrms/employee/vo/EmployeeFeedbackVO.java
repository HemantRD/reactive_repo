 ...
 * 
 */
public class EmployeeFeedbackVO {
	...
	private List<ProbationFeedbackVO> feedback;
	...
	public List<ProbationFeedbackVO> getFeedback() {
		return feedback;
	}

	public void setFeedback(List<ProbationFeedbackVO> feedback) {
