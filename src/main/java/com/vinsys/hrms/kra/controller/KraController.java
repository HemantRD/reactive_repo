...
public class KraController {
    ...
    HRMSBaseResponse<String> initiateDepartmentLevelAiAnalysis(@RequestParam(required = true) String role, @RequestParam(required = false) Long deptId) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole(role);
    ...
    HRMSBaseResponse<String> initiateDepartmentLevelAiAnalysisForCalibration(@RequestParam(required = true) String role, @RequestParam(required = true) Long ratingId, @RequestParam(required = false) Long deptId) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole(role);
...
//    }
	...
	public HRMSBaseResponse<String> addOrUpdateQuestionAnswer(
