...
public class KraController {
    ...
    @Autowired
    IKpiPmsAiService kpiPmsAiService;
	@Value("${app_version}")
	...
	@Operation(summary = "get Self assesment drafting assistance by AI", description = "Employee will get grafting assistance from AI")
	@PostMapping("getselffeedbackdraft")
	HRMSBaseResponse<ObjectiveFeedbackResponseVo> getSelfFeedbackDraft(@RequestBody ObjectiveFeedbackVo request) {
		HRMSBaseResponse<ObjectiveFeedbackResponseVo> response = new HRMSBaseResponse<>();
		try {
			response = kraService.getSelfFeedbackDraft(request);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
	...
	@Operation(summary = "get Self assesment drafting assistance by AI", description = "Employee will get grafting assistance from AI")
	@PostMapping("getmanagerfeedbackdraft")
	HRMSBaseResponse<ObjectiveFeedbackResponseVo> getManagerFeedbackDraft(@RequestBody ObjectiveFeedbackVo request) {
		HRMSBaseResponse<ObjectiveFeedbackResponseVo> response = new HRMSBaseResponse<>();
		try {
			response = kraService.getManagerFeedbackDraft(request);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
	...
	@Operation(summary = "KRA Rejected by HOD", description = "")
	...
	HRMSBaseResponse<String> acceptKpi(@RequestBody RejectRequestVo request) {
		...
		try {
			...
			kraService.sendKpiFeedbackForAiSummarization(request.getKraId());
    ...
    @Operation(summary = "get ceo dashboard data", description = "get ceo dashboard data")
    @GetMapping("/getorgleveldashboard")
    HRMSBaseResponse<KraCeoDashboardResponseVO> getOrgLevelDashboard() {
        HRMSBaseResponse<KraCeoDashboardResponseVO> response = new HRMSBaseResponse<>();
        try {
            response = kraService.getOrgLevelDashboard();
            response.setApplicationVersion(applicationVersion);
        } catch (HRMSException e) {
            log.error(e.getMessage(), e);
    ...
    @Operation(summary = "get HOD dashboard data", description = "get HOD dashboard data")
    @GetMapping("/getdepartmentleveldashboard")
    HRMSBaseResponse<KraCeoDashboardResponseVO> getDepartmentLevelDashboard(
            @RequestParam(required = false) Long deptId) {
        HRMSBaseResponse<KraCeoDashboardResponseVO> response = new HRMSBaseResponse<>();
        try {
            response = kraService.getDepartmentLevelDashboard(deptId);
            response.setApplicationVersion(applicationVersion);
        } catch (HRMSException e) {
            log.error(e.getMessage(), e);
    ...
    @Operation(summary = "get HOD dashboard data for a function/division", description = "get HOD dashboard data for a function/division")
    @GetMapping("/getdivisionleveldashboard")
    HRMSBaseResponse<KraCeoDashboardResponseVO> getDivisionLevelDashboard(
            @RequestParam(required = true) Long deptId, @RequestParam(required = true) Long divId) {
        HRMSBaseResponse<KraCeoDashboardResponseVO> response = new HRMSBaseResponse<>();
        try {
            response = kraService.getDivisionLevelDashboard(deptId, divId);
            response.setApplicationVersion(applicationVersion);
        } catch (HRMSException e) {
            log.error(e.getMessage(), e);
    ...
    @Operation(summary = "calculate department level aggregations", description = "This API is use to calculate department level aggregations")
    @GetMapping("/calculatedepartmentlevelaggregations")
    HRMSBaseResponse<String> calculateDepartmentLevelAggregations(@RequestParam(required = true) String role, @RequestParam(required = false) Long deptId) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole(role);
            kpiPmsAiService.calculateDepartmentLevelAggregations(requestInvokerVO, deptId);
    ...
    @Operation(summary = "initiate department level ai analysis", description = "This API is use to initiate department level ai suggestions")
    @GetMapping("/initiatedepartmentlevelaianalysis")
    HRMSBaseResponse<String> initiateDepartmentLevelAiAnalysis(@RequestParam(required = true) String role, @RequestParam(required = true) Long deptId) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole(role);
            requestInvokerVO.setPurpose("REVIEW_ASSISTANCE");
            requestInvokerVO.setLevelOfAnalysis("DEPARTMENT");
            //kpiPmsAiService.validateIfProcessIsAlreadyInProgress(requestInvokerVO, deptId);
            kpiPmsAiService.doDepartmentLevelAnalysis(requestInvokerVO, deptId);
            response.setResponseMessage(IHRMSConstants.successMessage);
            response.setResponseBody(IHRMSConstants.successMessage);
            response.setApplicationVersion(applicationVersion);
        } catch (HRMSException e) {
    ...
    @Operation(summary = "initiate department level ai analysis for calibration", description = "This API is use to initiate department level ai suggestions for calibration process")
    @GetMapping("/initiateDepartmentLevelAiAnalysisForCalibration")
    HRMSBaseResponse<String> initiateDepartmentLevelAiAnalysisForCalibration(@RequestParam(required = true) String role, @RequestParam(required = true) Long ratingId, @RequestParam(required = true) Long deptId) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole(role);
            requestInvokerVO.setPurpose("CALIBRATION_SUGGESTION");
            requestInvokerVO.setLevelOfAnalysis("DEPARTMENT");
            requestInvokerVO.setRatingId(ratingId);
            //kpiPmsAiService.validateIfProcessIsAlreadyInProgress(requestInvokerVO, deptId);
            kpiPmsAiService.doDepartmentLevelAnalysis(requestInvokerVO, deptId);
            response.setResponseMessage(IHRMSConstants.successMessage);
            response.setResponseBody(IHRMSConstants.successMessage);
    ...
    @Operation(summary = "calculate organisation level aggregations", description = "This API is use to calculate organisation level aggregations")
    @GetMapping("/calculateorganisationlevelaggregations")
    HRMSBaseResponse<String> calculateOrganisationLevelAggregations(@RequestParam(required = true) String role) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoRole(role);
            kpiPmsAiService.calculateOrganisationLevelAggregations(requestInvokerVO);
            response.setResponseMessage(IHRMSConstants.successMessage);
            response.setResponseBody(IHRMSConstants.successMessage);
            response.setApplicationVersion(applicationVersion);
        } catch (HRMSException e) {
    ...
    @Operation(summary = "initiate organisation level ai analysis", description = "This API is use to initiate organisation level ai suggestions")
    @GetMapping("/initiateorganisationlevelaianalysis")
    HRMSBaseResponse<String> initiateOrganisationLevelAiAnalysis(@RequestParam(required = true) String role) {
        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
        try {
            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole(role);
            requestInvokerVO.setPurpose("REVIEW_ASSISTANCE");
            requestInvokerVO.setLevelOfAnalysis("ORGANISATION");
            //kpiPmsAiService.validateIfProcessIsAlreadyInProgress(requestInvokerVO, null);
            kpiPmsAiService.doOrganisationLevelAnalysis(requestInvokerVO);
            response.setResponseMessage(IHRMSConstants.successMessage);
            response.setResponseBody(IHRMSConstants.successMessage);
            response.setApplicationVersion(applicationVersion);
        } catch (HRMSException e) {
...
//    @Operation(summary = "initiate organisation level ai analysis for calibration", description = "This API is use to initiate organisation level ai suggestions for calibration process")
//    @GetMapping("/initiateOrganisationLevelAiAnalysisForCalibration")
//    HRMSBaseResponse<String> initiateOrganisationLevelAiAnalysisForCalibration(@RequestParam(required = true) Long ratingId) {
//        HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
//        try {
//            AiMsBackgroundAnalysisRequestInvokerVO requestInvokerVO = kpiPmsAiService.validateCeoOrHodRole();
////            requestInvokerVO.setPurpose("CALIBRATION_ASSISTANCE");
//            requestInvokerVO.setPurpose("CALIBRATION_SUGGESTION");
//            requestInvokerVO.setRatingId(ratingId);
//            kpiPmsAiService.doOrganisationLevelAnalysis(requestInvokerVO);
//            response.setResponseMessage(IHRMSConstants.successMessage);
...
//    }
	...
	public HRMSBaseResponse<String> submitKpiForm(@RequestParam("kraId") Long kraId) {
		...
		try {
			...
			kraService.sendKpiFeedbackForAiSummarization(kraId);
	...
	@Operation(summary = "Delete KPI Template Form", description = "Deletes a KPI Template by its ID. Only HR or Admin can perform this operation.")
	@PostMapping("/delete-template")
	public HRMSBaseResponse<String> deleteTemplate(@RequestBody DeleteTemplateRequestVo request) {
		HRMSBaseResponse<String> response = new HRMSBaseResponse<>();

		try {
			response = kpiService.deleteTemplate(request);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error("HRMSException in submitKpiForm: {}", e.getMessage(), e);
			response.setResponseCode(e.getResponseCode());
	...
	@Operation(summary = "Save HR to Department Mapping", description = "Saves HR to Department mapping. Only HR or Admin can perform this operation.")
	@PostMapping("/savehrtodepartment")
	public HRMSBaseResponse<String> saveHrToDepartment(@RequestBody HrToDepartmentBulkVO request){
		HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
		try {
	        response = kpiService.saveHrToDepartment(request);
	        response.setApplicationVersion(applicationVersion);
	    } catch (HRMSException e) {
	        log.error(e.getMessage(), e);
	        response.setResponseCode(e.getResponseCode());
	...
	@Operation(summary = "get KPI Form to Role mappings", description = "Fetches the KPI form download permissions for roles.")
	@GetMapping("/kpiformtorole")
	HRMSBaseResponse<List<KpiFormToRoleResponseVO>> kpiFormRole() {
		HRMSBaseResponse<List<KpiFormToRoleResponseVO>> response = new HRMSBaseResponse<>();
		try {
			response = kpiService.kpiFormRole();
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
			response.setResponseCode(e.getResponseCode());
	...
	@Operation(
		    summary = "Toggle KPI Form to Role Active Status",
		    description = "Toggles the `is_active` flag (Y ↔ N) based on the given ID. Only `id` is required; all other fields are ignored."
		)
		@PostMapping("/setstatuskpiformtorole")
		public HRMSBaseResponse<String> saveKpiFormRole(@RequestBody KpiFormToRoleRequestVO requestVO) {

		    HRMSBaseResponse<String> response = new HRMSBaseResponse<>();

		    try {
		        if (requestVO.getId() == null) {
		            throw new HRMSException(1202, ResponseCode.getResponseCodeMap().get(1202));
		        }

		        response = kpiService.saveKpiFormRole(requestVO);
		        response.setApplicationVersion(applicationVersion);
		    }
		    catch (HRMSException e) {
	...
	@Operation(summary = "Activate KPI Year", description = "This API allows HR/Admin to activate a specific KPI year. When activated, all other years become inactive. If any open cycle exists for another year, activation is not allowed.")
	@PostMapping("activateyear")
	public HRMSBaseResponse<String> activateYear(@RequestBody KraYearVo request) {
	    HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
	    try {
	        response = kraService.activateYear(request);
	        response.setResponseBody(ResponseCode.getResponseCodeMap().get(1200));
	        response.setApplicationVersion(applicationVersion);
	    } catch (HRMSException e) {
	        log.error(e.getMessage(), e);
	...
	@Operation(summary = "Get funtionhead to Division mapping by funtionhead ID", description = "Returns division details mapped to a specific FuntionHead (by employee ID).")
	@GetMapping("/getfuntionheads")
	public HRMSBaseResponse<List<FuntionHeadToDivisionVO>> getfuntionheadtodivision(Pageable pageable) {
		...
		try {
			response = kraService.getfuntionheadtodivision(pageable);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
			response.setResponseCode(e.getResponseCode());
	...
	@Operation(summary = "")
	@PostMapping("/savemapfunctionhead")
	public HRMSBaseResponse<String> functionheadtofunction(@RequestBody FunctionheadsToFunctionVO request) throws HRMSException {
		HRMSBaseResponse<String> response = new HRMSBaseResponse<>();

		try {
			response = kpiService.functionheadtofunction(request);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error("HRMSException in submitKpiForm: {}", e.getMessage(), e);
			response.setResponseCode(e.getResponseCode());
	...
	@Operation(summary = "paginated list of department to division mappings with division names")
	@GetMapping("/get_department_by_fuction")
	public HRMSBaseResponse<List<MapDepartmentToDivisionVO>> getmapdepartmenttodivision(Pageable pageable) {
		...
		try {
			response = kraService.getmapdepartmenttodivision(pageable);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
			response.setResponseCode(e.getResponseCode());
	...
	@Operation(summary = "Add or Update Question & Answer (Bulk)", description = "Submit answers for one or multiple KPI/KRA questions. Allowed roles: EMPLOYEE, MANAGER, DELEGATOR")
	@PostMapping("add_update_question_answer")
	public HRMSBaseResponse<submitQuestionAnswerResponseVo> addOrUpdateQuestionAnswer(
			@Valid @RequestBody QuestionAnswerBulkRequestVO requestVO) {

		log.info("API Hit: /question-answer/save");

		HRMSBaseResponse<submitQuestionAnswerResponseVo> response = new HRMSBaseResponse<>();

		try {

			response = kpiService.addOrUpdateQuestionAnswer(requestVO);
			response.setApplicationVersion(applicationVersion);

		} catch (HRMSException e) {

			log.error("HRMSException in addOrUpdateQuestionAnswer: {}", e.getMessage(), e);
			...
			log.error("Exception in addOrUpdateQuestionAnswer: {}", e.getMessage(), e);
	...
	@Operation(summary = "get KPI details by ID", description = "Emloyee and manager can view kra details by KPI Id")
	@GetMapping("get-kpi-form-details")
	HRMSBaseResponse<NewKraResponse> getNewKpiById(@RequestParam(required = true) Long kraid) {
		HRMSBaseResponse<NewKraResponse> response = new HRMSBaseResponse<>();
		try {
			response = kraService.getNewKpiById(kraid);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
	...
	@Operation(summary = "Get Question & Answer by KRA", description = "Fetches answer details based on KRA Id, Category Id, and SubCategory Id. Employee role is mandatory. Only Employee with HR or Admin can access.")
	@PostMapping("/get-question-answers-kpiId")
	public HRMSBaseResponse<QuestionAnswerResponseVO> getQuestionAnswersByKraId(
			@RequestBody QuestionAndAnswerByKraIdRequestVO request) {

		HRMSBaseResponse<QuestionAnswerResponseVO> response = new HRMSBaseResponse<>();

		try {
			response = kpiService.getQuestionAnswersByKraId(request);
			response.setApplicationVersion(applicationVersion);
		} catch (HRMSException e) {
			log.error(e.getMessage(), e);
			response.setResponseCode(e.getResponseCode());
	...
	@Operation(summary = "Get active employee division details by division ID", description = "Fetch active employee and division details using division ID")
	@GetMapping("/get-active-employee-division")
	public HRMSBaseResponse<List<EmployeeDivisionVo>> getActiveEmployeesByDivisionId(
			@RequestParam(required = true) Long divisionId) {

		HRMSBaseResponse<List<EmployeeDivisionVo>> response = new HRMSBaseResponse<>();

		try {
			response = kraService.getActiveEmployeesByDivisionId(divisionId);
	...
	@Operation(summary = "Delete HR to Department Mapping", description = "Delete HR to Department mapping. Only HR or Admin can perform this operation.")
	@PostMapping("/deletehrtodepartment")
	public HRMSBaseResponse<String> deleteHrToDepartment(@RequestBody HrToDepartmentRequestVo request){
		HRMSBaseResponse<String> response = new HRMSBaseResponse<>();
		try {
	        response = kpiService.deleteHrToDepartment(request);
	        response.setApplicationVersion(applicationVersion);
	    } catch (HRMSException e) {
	        log.error(e.getMessage(), e);
	        response.setResponseCode(e.getResponseCode());
