...
public class KraResponseVO {
	...
	private String mcMemberCorrectionComment;
    ...
    private AiFeedbackObjectVO calibrateAiComment;
    private String functionHeadRejectedComment;
    ...
    public AiFeedbackObjectVO getCalibrateAiComment() {
        return calibrateAiComment;
    }

    public void setCalibrateAiComment(AiFeedbackObjectVO calibrateAiComment) {
        this.calibrateAiComment = calibrateAiComment;
    }
    
	public String getFunctionHeadRejectedComment() {
		return functionHeadRejectedComment;
	}
	public void setFunctionHeadRejectedComment(String functionHeadRejectedComment) {
		this.functionHeadRejectedComment = functionHeadRejectedComment;
	}
	public String getMcMemberCorrectionComment() {
		return mcMemberCorrectionComment;
	}
	public void setMcMemberCorrectionComment(String mcMemberCorrectionComment) {
		this.mcMemberCorrectionComment = mcMemberCorrectionComment;
	}
