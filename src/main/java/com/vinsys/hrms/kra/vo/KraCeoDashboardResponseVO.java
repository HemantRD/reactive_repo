...
public class KraCeoDashboardResponseVO {
    ...
    private AggregatedScoreVO divisionScore;
    private List<AggregatedScoreVO> divisionScores;
    ...
    public AggregatedScoreVO getDivisionScore() {
        return divisionScore;
    }

    public void setDivisionScore(AggregatedScoreVO divisionScore) {
        this.divisionScore = divisionScore;
    }

    public List<AggregatedScoreVO> getDivisionScores() {
        return divisionScores;
    }

    public void setDivisionScores(List<AggregatedScoreVO> divisionScores) {
        this.divisionScores = divisionScores;
    }
