...
@Entity
@Table(name = "tbl_trn_kra_details")
public class KraDetails extends AuditBase {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name = "seq_trn_kra_details", sequenceName = "seq_trn_kra_details", initialValue = 1, allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_trn_kra_details")
	private Long id;
