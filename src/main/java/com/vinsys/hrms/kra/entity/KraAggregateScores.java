...
public class KraAggregateScores {
    ...
    @Column(name = "calibration_processing_progress_status")
    private String calibrationProcessingProgressStatus;
    @Column(name = "review_processing_progress_status")
    private String reviewProcessingProgressStatus;
    ...
    public String getCalibrationProcessingProgressStatus() {
        return calibrationProcessingProgressStatus;
    }

    public void setCalibrationProcessingProgressStatus(String calibrationProcessingProgressStatus) {
        this.calibrationProcessingProgressStatus = calibrationProcessingProgressStatus;
    }

    public String getReviewProcessingProgressStatus() {
        return reviewProcessingProgressStatus;
    }

    public void setReviewProcessingProgressStatus(String reviewProcessingProgressStatus) {
        this.reviewProcessingProgressStatus = reviewProcessingProgressStatus;
    }
}
