...
@Entity
@Table(name = "tbl_mst_kra_cycle")
public class KraCycle extends AuditBase {

	@Id
	@SequenceGenerator(name = "seq_mst_kra_cycle", sequenceName = "seq_mst_kra_cycle", initialValue = 1, allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_mst_kra_cycle")
	private Long id;
