...
public interface IKraService {
	...
	HRMSBaseResponse<ObjectiveFeedbackResponseVo> getSelfFeedbackDraft(ObjectiveFeedbackVo request) throws HRMSException, Exception;

	HRMSBaseResponse<ObjectiveFeedbackResponseVo> getManagerFeedbackDraft(ObjectiveFeedbackVo request) throws HRMSException, Exception;
	...
	void sendKpiFeedbackForAiSummarization(Long kraId) throws Exception;
	
	HRMSBaseResponse<String> activateYear(KraYearVo request) throws HRMSException;

    HRMSBaseResponse<KraCeoDashboardResponseVO> getOrgLevelDashboard() throws HRMSException;

    HRMSBaseResponse<KraCeoDashboardResponseVO> getDepartmentLevelDashboard(Long deptId) throws HRMSException;

    HRMSBaseResponse<KraCeoDashboardResponseVO> getDivisionLevelDashboard(Long deptId, Long divId) throws HRMSException;

	HRMSBaseResponse<List<FuntionHeadToDivisionVO>> getfuntionheadtodivision(Pageable pageable)throws HRMSException;

	HRMSBaseResponse<List<MapDepartmentToDivisionVO>> getmapdepartmenttodivision(Pageable pageable)throws HRMSException;

	HRMSBaseResponse<NewKraResponse> getNewKpiById(Long kraid) throws HRMSException;

	HRMSBaseResponse<List<EmployeeDivisionVo>> getActiveEmployeesByDivisionId(Long divisionId) throws HRMSException;
}
