...
public class CurrentEmploymentResponseVO {
	...
	private Set<VOLoginEntityType> roles;
	public Long getId() {
		return id;
	}
	...
	public Set<VOLoginEntityType> getRoles() {
		return roles;
	}
	public void setRoles(Set<VOLoginEntityType> roles) {
		this.roles = roles;
	}
