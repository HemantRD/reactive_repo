...
public interface IDirectOnboardProcessor {

	public HRMSBaseResponse<?> addProfileDetails(ProfileDetailsRequestVO request) throws HRMSException, ParseException, NoSuchAlgorithmException;
	...
	public HRMSBaseResponse<?> addPreviousEmployment(PreviousEmploymentRequestVO request) throws HRMSException, ParseException;
	...
	HRMSBaseResponse<?> saveEducationDetails(EducationalDetailsVO educationalDetailsVo)
	...
	public HRMSBaseResponse<?> uploadFile(MultipartFile[] request, FileUploadRequestVO requestVO) throws HRMSException, IOException;
	...
	public HRMSBaseResponse<?> updateProfileDetails(ProfileDetailsRequestVO request) throws HRMSException, ParseException, NoSuchAlgorithmException;
