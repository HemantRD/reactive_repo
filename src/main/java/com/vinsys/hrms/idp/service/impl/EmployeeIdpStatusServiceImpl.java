...
public class EmployeeIdpStatusServiceImpl implements IEmployeeIdpStatusService {
    ...
    public HRMSBaseResponse<List<EmployeeIdpStatusVO>> getOrganizationEmployeesForIdp(EmpStatusListingReq request,
        ...
        request.setBranch(request.getBranch() == null ? "" : request.getBranch());
        String keywordU;
        ...
        Page<IdpOrganizationEmployeeView> employeePage =
                idpOrganizationEmployeeViewDAO.findOrgEmployeesByPage(keywordU, request.getBranchId(),
    ...
    @Override
    public byte[] getOrganizationEmployeesForIdpExcel(EmpStatusListingReq request) throws HRMSException {
        ...
        List<IdpOrganizationEmployeeView> employeePage =
                idpOrganizationEmployeeViewDAO.findOrgEmployeesExcel(keywordU, request.getBranchId(),
                        request.getBranch(), request.getDeptId(), request.getGradeId(), request.getIdpSubmissionStatus(),
                        sort);
        ...
        try (Workbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            String title = "EmployeeCornerReport";
