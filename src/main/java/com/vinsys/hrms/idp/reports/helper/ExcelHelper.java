...
public class ExcelHelper {
    ...
    public static Cell createCell(Row row, int index, String value, CellStyle style) {
        ...
        if (value != null) {
            ...
            cell0.setCellValue(NO_VALUE);
        }
        cell0.setCellStyle(style);
        return cell0;
    }

    public static Cell createCell(Row row, int index, Boolean value, CellStyle style) {
        Cell cell0 = row.createCell(index);
        if (value != null) {
            cell0.setCellValue(value);
        } else {
    ...
    public static Cell createCell(Row row, int index, Date value, CellStyle style) {
        Cell cell0 = row.createCell(index);
        if (value != null) {
            cell0.setCellValue(HRMSDateUtil.format(value, IHRMSConstants.FRONT_END_DATE_FORMAT));
        } else {
            cell0.setCellValue(NO_VALUE);
        }
        cell0.setCellStyle(style);
    ...
    public static Sheet createInitialSheet(Workbook workbook, String title, String headers[], LogoService logoService) {
        ...
        try {
            ...
            log.warn("Logo file not found or could not be read: " + e.getMessage());
        }
