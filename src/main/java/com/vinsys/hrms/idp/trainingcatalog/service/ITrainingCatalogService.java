...
public interface ITrainingCatalogService {
    ...
    byte[] getAllTrainingCatalogsExcel(TrainingCatalogListingReq request) throws HRMSException;
    ...
    byte[] getAllTrainingBudgetsExcel(Integer year) throws HRMSException;

    HRMSBaseResponse<String> updateTrainingStatus(TrainingCatalogStatus trainingCatalogStatus) throws HRMSException;

    HRMSBaseResponse<String> updateTrainingBudgetStatus(TrainingBudgetStatus trainingBudgetStatus) throws HRMSException;
