    ...
    public void validateAddUpdateBudget(TrainingBudgetVo trainingBudgetVo) throws HRMSException {
        ...
        if (HRMSHelper.isNullOrEmpty(trainingBudgetVo.getCurrencySymbol())) {
         ...
         if (trainingBudgetVo.getYear() == null || trainingBudgetVo.getYear() <= 0 ||
            ...
            throw new HRMSException(1501, ResponseCode.getResponseCodeMap().get(1501) + " yearId");
        }
        ...
        if (trainingBudgetDAO.yearAlreadyExist(trainingBudgetVo.getYear(), trainingBudgetVo.getId())) {
            throw new HRMSException(1501, ResponseCode.getResponseCodeMap().get(1546) + " For yearId");
        }
    }
}
