...
public class EmployeeLeaveSumarryDetailsVO {

	
	private MasterLeaveTypeVO masterLeaveType;
	...
	public MasterLeaveTypeVO getMasterLeaveType() {
		return masterLeaveType;
	}
	public void setMasterLeaveType(MasterLeaveTypeVO masterLeaveType) {
